...
interface HTMLElementsFrontPanel {
    brandLogo: HTMLImageElement,
    bankLogo: HTMLImageElement,
    frontPanel: HTMLDivElement
}
export type FSetStateFrontPanel = (length: number, value: string, valuePaymentNumbers: () => string, {brandLogo, bankLogo, frontPanel}: HTMLElementsFrontPanel) => void
